...
// console.log(endtime);
// console.log((endtime-starttime)*Math.pow(10,6));
...
// for (let i = 0; i < 50; i++)
// {
//     //Heavy Calculation or API Hit
// }

// let stop = window.performance.now();

// console.log(`Time Taken to execute: ${start-stop} seconds`)
...
let startdate = '2020-03-04:10:08:08.123Z';
let enddate = '2020-03-04:10:10:08.123Z';
console.log(new Date(
    new Date(startdate).getTime()+(Math.random()*(new Date(enddate).getTime()-new Date(startdate).getTime()))
  ).toISOString()
);